...
export class BlogComponent implements OnInit {
  ...
  onBlogSubmit() {
    ...
    const blog = {
      ...
      createdBy: this.username || this.vendorname // CreatedBy field
    }
  ...
  ngOnInit() {
    ...
    // Get profile vendorname on page load
    this.vendorauthService.getProfile().subscribe(profile => {
      this.vendorname = profile.vendor.vendorname; // Used when creating new blog posts and comments
    });
